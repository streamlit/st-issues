...
st.write("**Expected:** Clicking the button multiple times should replace the existing dataframe.")
st.write("**Actual:** Each click appends a new copy of the dataframe instead of replacing it.")
