...
st.caption("Click on a bar to view all open issues with that label.")
...
# Display the chart
feature_event_data = st.plotly_chart(fig_labels, use_container_width=True, on_select="rerun")
...
if feature_event_data and "selection" in feature_event_data and feature_event_data["selection"]["points"]:
    ...
    if not selected_feature_issues.empty:
        ...
        st.info(f"No issues found with the selected feature label.")
